...
import { placeMarkController } from "./controllers/placemark-contoller.js";
...
export const webRoutes = [
  ...
  { method: "GET", path: "/placemark/{id}/deleteplace/{trackid}", config: placeMarkController.deletePlace },
];
